---
summary: "連接到每個 OpenClaw 文件的中樞"
read_when:
  - 想要完整的文件地圖
title: "Docs Hubs（文件中樞）"
---

# 文件中樞

<Note>
如果你是 OpenClaw 新手，請先從 [開始使用](/zh-Hant/start/getting-started) 開始。
</Note>

使用這些中樞來發現每個頁面，包括未出現在左側導航中的深入內容和參考文件。
...
- [OpenClaw 助手](/zh-Hant/start/openclaw)
- [展示](/zh-Hant/start/showcase)
- [故事](/zh-Hant/start/lore)
...
- [會話（別名）](/zh-Hant/concepts/sessions)
- [會話清理](/zh-Hant/concepts/session-pruning)
- [會話工具](/zh-Hant/concepts/session-tool)
- [佇列](/zh-Hant/concepts/queue)
- [斜線命令](/zh-Hant/tools/slash-commands)
- [RPC 適配器](/zh-Hant/reference/rpc)
- [TypeBox 架構](/zh-Hant/concepts/typebox)
- [時區處理](/zh-Hant/concepts/timezone)
- [在線狀態](/zh-Hant/concepts/presence)
- [發現 + 傳輸](/zh-Hant/gateway/discovery)
...
- [聊天頻道中樞](/zh-Hant/channels)
- [模型提供者中樞](/zh-Hant/providers/models)
- [WhatsApp](/zh-Hant/channels/whatsapp)
- [Telegram](/zh-Hant/channels/telegram)
- [Telegram（grammY 筆記）](/zh-Hant/channels/grammy)
...
- [iMessage（遺舊）](/zh-Hant/channels/imessage)
- [位置解析](/zh-Hant/channels/location)
- [WebChat](/zh-Hant/web/webchat)
- [Webhook](/zh-Hant/automation/webhook)
...
- [思考 + 詳細](/zh-Hant/tools/thinking)
- [模型](/zh-Hant/concepts/models)
- [子 agent](/zh-Hant/tools/subagents)
- [Agent send CLI](/zh-Hant/tools/agent-send)
- [終端 UI](/zh-Hant/web/tui)
...
- [節點概述](/zh-Hant/nodes)
- [攝像機](/zh-Hant/nodes/camera)
- [圖像](/zh-Hant/nodes/images)
- [音頻](/zh-Hant/nodes/audio)
- [位置命令](/zh-Hant/nodes/location-command)
- [語音喚醒](/zh-Hant/nodes/voicewake)
- [談話模式](/zh-Hant/nodes/talk)

## 平台

- [平台概述](/zh-Hant/platforms)
...
- [macOS 語音疊加層](/zh-Hant/platforms/mac/voice-overlay)
...
- [macOS 健康](/zh-Hant/platforms/mac/health)
- [macOS 圖標](/zh-Hant/platforms/mac/icon)
- [macOS 日誌](/zh-Hant/platforms/mac/logging)
- [macOS 權限](/zh-Hant/platforms/mac/permissions)
- [macOS 遠端](/zh-Hant/platforms/mac/remote)
- [macOS 簽署](/zh-Hant/platforms/mac/signing)
- [macOS 發佈](/zh-Hant/platforms/mac/release)
...
- [入門設定協議](/zh-Hant/experiments/onboarding-config-protocol)
- [Cron 加固筆記](/zh-Hant/experiments/plans/cron-add-hardening)
- [群組原則加固筆記](/zh-Hant/experiments/plans/group-policy-hardening)
- [研究：記憶](/zh-Hant/experiments/research/memory)
- [模型設定探索](/zh-Hant/experiments/proposals/model-config)

## 專案

- [致謝](/zh-Hant/reference/credits)

## 測試和發佈

- [測試](/zh-Hant/reference/test)
- [發佈檢查清單](/zh-Hant/reference/RELEASING)
