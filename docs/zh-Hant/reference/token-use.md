...
title: "Token Use and Costs（代幣使用和成本）"
---
...
Configure it in [Gateway configuration](/zh-Hant/gateway/configuration) and see the
behavior details in [Session pruning](/zh-Hant/concepts/session-pruning).
...
For a full knob-by-knob guide, see [Prompt Caching](/zh-Hant/reference/prompt-caching).
...
See [Skills](/zh-Hant/tools/skills) for the exact skill list overhead formula.
