...
title: "Oracle Cloud (Platform)（Oracle Cloud）"
---
...
- [Gateway remote access](/zh-Hant/gateway/remote) — other remote access patterns
- [Tailscale integration](/zh-Hant/gateway/tailscale) — full Tailscale docs
- [Gateway configuration](/zh-Hant/gateway/configuration) — all config options
- [DigitalOcean guide](/zh-Hant/platforms/digitalocean) — if you want paid + easier signup
- [Hetzner guide](/zh-Hant/install/hetzner) — Docker-based alternative
